...
namespace Util
{
    // https://github.com/RandomiaGaming/Unity2DPixelPerfectCollider/blob/41ee2e08f09035bbf78ed896201845d28c1279b8/PixelCollider2D.cs
    public sealed class PixelCollider2D : MonoBehaviour
    {
        ...
        public void Regenerate()
        {
            ...
            if (SR.sprite.texture.isReadable == false)
            {
                PGC2D.pathCount = 0;
                throw new Exception(
                    $"PixelCollider2D could not be regenerated on \"{gameObject.name}\" because the sprite does not allow read/write operations.");
            }
